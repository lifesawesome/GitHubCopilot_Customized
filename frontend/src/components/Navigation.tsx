      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center space-x-4">
            {isAdmin && (
              <Link
                to="/admin/python-analytics"
                className="bg-primary hover:bg-accent text-white px-3 py-2 rounded-md text-sm font-medium transition-colors"
              >
                Admin Analytics
              </Link>
            )}
            ...
            <button
              ...
              className={`relative p-2 rounded-full transition-colors ${darkMode ? 'text-gray-300 hover:text-primary' : 'text-gray-600 hover:text-primary'}`}
            >
